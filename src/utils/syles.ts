...
const BREAKPOINTS: { [key: string]: string } = {
  sm: "640px", // 640px or larger
  md: "768px", // 768px or larger
  lg: "1024px", // 1024px or larger
  xl: "1280px", // 1280px or larger
};
...
function isFontSizeThemeKeys<T>(
  prop: any,
  theme: AppTheme
...
function isLetterSpacingThemeKeys<T>(
  prop: any,
  theme: AppTheme
...
function isLineHeightThemeKeys<T>(
  prop: any,
  theme: AppTheme
